...
import { useCreateOrderMutation } from '../../../../models/post'
import * as Yup from 'yup'
import { store, type RootState } from '../../../../models/index'
      ...
      <Form>
        <EntregaDiv>
          ...
          <EntregaInfoDiv>
            ...
            <ErrorMessage
              name="Nome"
              render={(msn: any) => <ErrorTooltip>{msn}</ErrorTooltip>}
            />
          </EntregaInfoDiv>
          <EntregaInfoDivGrid>
            <EntregaInfoDiv>
              <EntregaLabel>Número do Cartao</EntregaLabel>
